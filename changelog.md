...
19. **时光机支持多条消息发送，支持混合类型发送**
20. 时光机支持发送隐私评论(消息开头加上`#`即可)
21. **时光机增加"那年今日"(默认关闭，需要在外观设置——时光机——那年今日开启功能)**
22. 增加分类默认展开设置(外观设置——主题增强功能里有)
23. 增加文章页面打赏按钮下方文字自定义选项(外观设置——初级设置——文章页面打赏默认提示文字)
24. 增加手机模式下单独设置背景图片
25. 优化搜索，增加搜索等待动画
26. 时光机其他的RSS订阅也可以使用灯箱效果了
27. 优化文章内的markdown样式(包括标题和代码块的显示(不会自动换行))
28. 优化了文章页面动画的效果(外观设置——主题增强功能——开启文章页面动画)
29. 优化了手机版本相册的显示，一排显示2个
30. 优化未读提醒
31. 删除了旧版本遗漏的多余css代码，优化性能
32. 修复伪静态带来的问题的地址问题
33. 修复搜索地址栏不变的问题
34. 修复时光机某些RSS订阅源时间错误问题
35. 修复豆瓣页面，提供更精确的错误信息
36. 修复字体大小调整无效的问题
37. 修复mathJax 链接写死的问题，现在已经同步后台的CDN公共库的设置
